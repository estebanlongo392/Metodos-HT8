...
# 2.1 Calcular las normas de Frobenius para A, B, A⁻¹ y B⁻¹
print("2.1 Normas de las matrices:")
...
# 2.2 Calcular el número de condicionamiento para A y B
print("2.2 Número de condicionamiento:")
...
# 2.3 Calcular el determinante para A y B
print("2.3 Determinantes de las matrices:")
...
# 2.4 Verificar el condicionamiento de las matrices
print("2.4 Condicionamiento de las matrices:")
